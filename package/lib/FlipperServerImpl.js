...
class FlipperServerImpl {
    constructor(config, logger, keytarModule) {
        ...
        this.commandHandler = {
            ...
            'node-api-fs-rm': async (path, { maxRetries } = {}) => new Promise((resolve, reject) => (0, rimraf_1.default)(path, { disableGlob: true, maxBusyTries: maxRetries }, (err) => err ? reject(err) : resolve())),
            ...
            'download-file-start': (0, DownloadFile_1.commandDownloadFileStartFactory)(this.emit.bind(this)),
