...
const flipper_doctor_1 = require("flipper-doctor");
const immer_1 = __importDefault(require("immer"));
async function getHealthChecks(options) {
    return (0, immer_1.default)((0, flipper_doctor_1.getHealthchecks)(), (healthchecks) => {
...
async function runHealthcheck(options, categoryName, ruleName) {
    const healthchecks = (0, flipper_doctor_1.getHealthchecks)();
    ...
    const envInfoPromise = (0, flipper_doctor_1.getEnvInfo)();
